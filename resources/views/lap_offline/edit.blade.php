@extends('layouts.app', ['activePage' => 'Edit laporan offline'])
@push('css')
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="mb-0">{{ __('Edit Laporan Offline') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('lap_off.update', $data->id) }}" enctype="multipart/form-data" autocomplete="off" id="form-order">
                            @csrf
                            @method('PUT')
                            @if (session('status'))
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="name" id="input-name" value="{{$data->name}}"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <textarea name="keterangan" class="form-control" id="keterangan" rows="2" placeholder="...">{{$data->keterangan}}</textarea>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="debit" id="input-debit-real"
                                            class="form-control form-control-alternative"
                                            placeholder="{{ __('debit') }}" value="{{$data->debit}}" hidden>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="credit" id="input-credit-real"
                                            class="form-control form-control-alternative"
                                            placeholder="{{ __('credit') }}" value="{{$data->credit}}" hidden>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">

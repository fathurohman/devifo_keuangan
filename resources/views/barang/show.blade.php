@extends('layouts.app', ['activePage' => 'barang']) @push('css')
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('barang.create') }}" class="btn btn-sm btn-primary">Add
                                    Barang</a>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        <a class="dropdown-item"
                                                            href="{{ route('barang.edit', $x->id) }}">Edit</a>
                                                        <form method="post" id="delete-form-{{ $x->id }}"
                                                            action="{{ route('barang.destroy', $x->id) }}"
                                                            style="display: none">

@extends('layouts.app', ['activePage' => 'Jurnal Bank'])
@push('css')
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Jurnal Bank</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('penerimaan_kas') }}" class="btn btn-sm btn-primary">Add Data</a>
                            </div>
                        </div>
                    </div>
